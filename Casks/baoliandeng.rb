# Deprecated: this cask has been upstreamed to homebrew/homebrew-cask
# (https://github.com/Homebrew/homebrew-cask/pull/257930).
# Use `brew install --cask baoliandeng` directly without tapping this repo.
cask "baoliandeng" do
  version "4.0"
